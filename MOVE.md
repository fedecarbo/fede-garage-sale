...
**28 items, ≈2.48 m³ of the 5 m³ quoted, 270.05 kg**, with one lot still to
...
the two Sonos One speakers and the pocket ironing board travel inside the large
black boxes**: their weight counts, their volume does not.
