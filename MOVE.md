...
**27 items, ≈2.48 m³ of the 5 m³ quoted, 270.05 kg**, with one lot still to
...
and the two Sonos One speakers travel inside the large black boxes**: their weight
counts, their volume does not. The pocket ironing board goes in a black box too,
but is not listed at all — like clothes or kitchenware, it is box contents with
nothing for customs to value.
